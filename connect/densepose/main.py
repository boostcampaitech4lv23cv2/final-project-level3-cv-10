...
async def create_file(
    ...
    id_2_str = str(uuid4())
    model_path = f"/opt/ml/backend/data/model_image/{id_2_str}.jpg"
    output_path = f"/opt/ml/backend/data/densepose_output/{id_2_str}.jpg"
    
    img.save(model_path)
    
    output = subprocess.getoutput(f"python densepose_new/create_Densepose.py dump \
